...
function CompleteInterface({ plan }: { plan: "39" | "69" | null }) {
  ...
  async function handleDownloadAll() {
    ...
    // Single timestamp reused across all files — ensures consistency throughout the dossier
    const exportedAt = new Date().toISOString();
    const isoDate    = exportedAt.slice(0, 10); // YYYY-MM-DD
    ...
    const readme = [
      ...
      "",
      "02_agreement/",
      "  purchase_agreement.html    Purchase agreement. Open in any browser to",
      "                             read or print. Includes Spanish and English.",
      "",
      "03_documents/",
    ...
    zip.file("00_overview/README.txt", readme);
    ...
    // Included only when generated. The auto-print script is stripped so the
    // file opens cleanly in a browser without immediately triggering a dialog.
    if (contract.status === "generated") {
      ...
      zip.file("02_agreement/purchase_agreement.html", agreementHtml);
    }
