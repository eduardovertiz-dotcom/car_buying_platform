    ...
    <main className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <h1 className="text-xl font-semibold text-white mb-2">
          Accede a tu expediente en MexGuardian
        </h1>
        <p className="text-sm text-[var(--foreground-muted)] mb-8">
          Inicia sesión para guardar y acceder a tus transacciones verificadas.
        </p>
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="text-xs text-[var(--foreground-muted)] opacity-60">o</span>
          <div className="flex-1 h-px bg-[var(--border)]" />
        </div>
        ...
        {sent ? (
          <p className="text-sm text-white/70 text-center">
            Revisa tu correo, te enviamos un enlace de acceso seguro.
          </p>
        ) : (
          <>
            <input
